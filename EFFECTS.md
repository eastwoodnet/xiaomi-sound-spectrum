...
## 5. 效果 4: 全频律动 (Full-Spectrum Dynamics: 18 频段连续色谱与峰值动力学)
...
- **实测物理硬件几何对齐**：
  ...
  - **90° 逆时针声光对齐校准**：实测将点灯顺序整体逆时针旋转 90°（偏移 4 颗灯珠，$\text{LED} = (b - 4 + 18) \pmod{18}$），将听感最丰富的高动态活跃区完美居中收束在音箱正正面（LED 8、9），人正对音箱时视觉冲击力最佳。
