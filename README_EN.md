...
> The default build, `deploy.py`, and `led_guard.sh` target **Xiaomi Sound (L06A, AW20054)**. Experimental support for **OH2P 1.62.2 (AW21036)** uses a separate deployment entry point; see the [OH2P guide](docs/oh2p.md) for validation scope. Compatibility with other models or firmware versions is not guaranteed.
